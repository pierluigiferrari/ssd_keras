...
n_classes = 1  # 1 # Number of positive classes
...
train_dataset.parse_csv(images_dir=images_train_dir,
                        labels_filename=train_labels_filename,
...
val_dataset.parse_csv(images_dir=images_valid_dir,
                      labels_filename=val_labels_filename,
...
classes = ['tire', 'car', 'truck', 'pedestrian', 'bicyclist', 'light'] # Just so we can print class names onto the image instead of IDs
